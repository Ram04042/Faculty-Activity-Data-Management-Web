...
$result = $conn->query($sql);
	...
	mkdir('C:/xampp/htdocs/internship_new/uploads/'.$id, 0777, true);
	...
	for($i = 0; $i < count($_FILES['cufile']['name']); $i++)
	{
		...
		mkdir('C:/xampp/htdocs/internship_new/uploads/'.$id.'/cur_img', 0777, true);
	...
	for($i = 0; $i < count($_FILES['exfile']['name']); $i++)
	{
		...
		mkdir('C:/xampp/htdocs/internship_new/uploads/'.$id.'/excur_img', 0777, true);
